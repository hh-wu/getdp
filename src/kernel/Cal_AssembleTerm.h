...
// double Val[]); void Cal_AssembleTerm_MH_Moving_separate(struct Dof * Equ,
// struct Dof * Dof, double Val[]); void Cal_AssembleTerm_MH_Moving_probe(struct
// Dof * Equ, struct Dof * Dof, double Val[]);
