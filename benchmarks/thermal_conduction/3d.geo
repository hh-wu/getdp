...
Point(2)  = {0.048, 0.012, 0, size/4};
Point(3)  = {0.048, 0.014, 0, size/4};
Point(4)  = {0.04,  0.014, 0, size/4};
Point(5)  = {0.04,  0.012, 0, size/4};
...
Point(22) = {0.048, 0.012, z, size/4};
Point(23) = {0.048, 0.014, z, size/4};
Point(24) = {0.04,  0.014, z, size/4};
Point(25) = {0.04,  0.012, z, size/4};
...
Point(35) = {0.048, 0.014, z/3, size/4};
Point(36) = {0.04,  0.014, z/3, size/4};
Point(37) = {0.048, 0.014, 2*z/3, size/4};
Point(38) = {0.04,  0.014, 2*z/3, size/4};

/* trou de mesure */

Point(40) = {0.044, 0.008, z/2, size/4};
Point(41) = {0.044, 0.011, z/2, size/4};
Point(42) = {0.044, 0.012, z/2, size/4};
