...
DefineConstant[
  ...
  k_geo = {10., Min 1., Max 100., Step 0.1, Name StrCat[MENU_GEO, MENU_WAVENUMBER, "1k_geo"]}
  //reference for discretization
  //(if band of frequencies for example)
  k_dis = {10., Min 1., Max 100., Step 0.1, Name StrCat[MENU_GEO, MENU_WAVENUMBER, "2k_dis"]}
];
...
DefineConstant[
  nDy = {15., Min 0.1, Max 100., Step 0.1, Name StrCat[MENU_GEO, MENU_TRM, "1Aperture"]}
  nDx = {0.2, Min 0.1, Max 10., Step 0.01, Name StrCat[MENU_GEO, MENU_TRM, "2Thickness"]}
  nL = {20., Min 1., Max 100., Step 0.1, Name StrCat[MENU_GEO, MENU_TRM, "3Distance to source"]}
];
...
DefineConstant[
  ...
  YS = {0., Min -Dy/2, Max Dy/2, Step 0.1, Name StrCat[MENU_GEO, MENU_SOURCE, "0Y coordinate"]}
];
XS = 0;
ZS = 0;
...
//=========
DefineConstant[
  linkLS = {1, Choices {0,1}, Name StrCat[MENU_GEO, MENU_PROP, "0Set distances TRM-Source = Source-Xmin"]}
  n_LS = {nL + nDx, Min 1., Max 30., Step 0.1, Name StrCat[MENU_GEO, MENU_PROP, "00Distance behind the source"], ReadOnly linkLS}
  n_LTRM = {Dy/4, Min Dy/10, Max 100., Step 0.1, Name StrCat[MENU_GEO, MENU_PROP, "1Distance behind the TRM"]}
  n_LY = {Dy/5, Min Dy/10, Max 100., Step 0.1, Name StrCat[MENU_GEO, MENU_PROP, "2Distance on top & bottom of the TRM"]}
];
...
DefineConstant[
  //TRM
  nlcTRM = {15., Min 1., Max 30., Step 0.1, Name StrCat[MENU_ADV, MENU_LC, "2TRM"], Closed 1}
  //Interne boundary separating propagation and absorbing domains
  nlcIntern_Bound = {10., Min 1., Max 30., Step 0.1, Name StrCat[MENU_ADV, MENU_LC, "2Boundary with PML"], Closed 1}
  //Extern boundary of the PML (truncation)
  nlcExtern_Bound = {10., Min 1., Max 30., Step 0.1, Name StrCat[MENU_ADV, MENU_LC, "2End of PML"], Closed 1}
  //Source (small open subset surrounding the source)
  nlcSourceExt = {15., Min 1., Max 30., Step 0.1, Name StrCat[MENU_ADV, MENU_LC, "2Around the source"], Closed 1}
  //source
  nlcSourceInt = {10., Min 1., Max 30., Step 0.1, Name StrCat[MENU_ADV, MENU_LC, "2Near the source"], Visible CLUTTER, Closed 1}
  //Scat
  nlcScat = {10., Min 1., Max 30., Step 0.1, Name StrCat[MENU_ADV, MENU_LC, "2Scatterers"], Visible CLUTTER, Closed 1}
];
...
DefineConstant[
  HidePML = {1, Choices{0,1}, Name StrCat[MENU_ADV, MENU_PML, "0Hide PML"], Closed 1}
  nSizePMLX = {10., Min 1., Max 30., Step 0.1, Name StrCat[MENU_ADV, MENU_PML, "00x-size"], Closed 1}
  nSizePMLY = {10., Min 1., Max 30., Step 0.1, Name StrCat[MENU_ADV, MENU_PML, "1y-size"]}
];
...
DefineConstant[
  ...
  nXboxmin = {nconst_Xboxmin, Min nconst_Xboxmin, Max nconst_Xboxmax, Step 0.1, Name StrCat[MENU_GEO, MENU_OBSTACLES, MENU_BOX_OBST, "40x-min"], Visible CLUTTER, Closed 1}
  nXboxmax = {nconst_Xboxmax, Min nconst_Xboxmin, Max nconst_Xboxmax, Step 0.1, Name StrCat[MENU_GEO, MENU_OBSTACLES, MENU_BOX_OBST,"41x-max"], Visible CLUTTER, Closed 1}
  nYboxmin = {nconst_Yboxmin, Min nconst_Yboxmin, Max nconst_Yboxmax, Step 0.1, Name StrCat[MENU_GEO, MENU_OBSTACLES, MENU_BOX_OBST,"42y-min"], Visible CLUTTER, Closed 1}
  nYboxmax = {nconst_Yboxmax, Min nconst_Yboxmin, Max nconst_Yboxmax, Step 0.1, Name StrCat[MENU_GEO, MENU_OBSTACLES, MENU_BOX_OBST,"43y-max"], Visible CLUTTER, Closed 1}
  dmin = {0.2, Min 0.01, Max 10., Step 0.01, Name StrCat[MENU_GEO, MENU_OBSTACLES, "/2dist. min between disks (in lambda_geo)"], Visible CLUTTER, Closed 1}
];
