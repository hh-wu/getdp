DefineConstant[
  ...
  Preset = {(TotalMemory <= 1024) ? 1 : 0,
    Choices{0="None", 1="1 round filament (AK benchmark)", 2="2 round filaments",
      3="36 round filaments (GE benchmark)", 4="1 rectangular tape"},
...
For i In {1:NumLayers}
  DefineConstant[
    NumFilaments~{i} = { (Preset == 3 && i == 1) ? 6 : (Preset == 3 && i == 2) ? 12 :
      (Preset == 3 && i == 3) ? 18 : (Preset == 2) ? 2 :
      (Preset == 1 || Preset == 4) ? 1 : 2 * i,
