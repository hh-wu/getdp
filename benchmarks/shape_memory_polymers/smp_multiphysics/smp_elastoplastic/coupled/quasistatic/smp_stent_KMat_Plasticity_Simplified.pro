Function {
  ...
  L_eg~{1}~{1}~{1}~{1}[] = ( (z_g[] == 0.0) ? 0.0 :
                             ( (z_g[] * Det[#2]#6 * (lambda_g * CompXX[U_[]#8] * CompXX[(#8)] +
  ...
  L_er~{1}~{1}~{1}~{1}[] = ( (z_g[] == 1.0) ? 0.0 :
                             ( ( (1.0 - z_g[]) * Det[#4]#7 * (lambda_r * CompXX[X_[]#9] * CompXX[(#9)] +
