  ...
  { Name Total_Lagrangian ; NameOfFormulation Total_Lagrangian ;
    ...
    PostQuantity {
      ...
      { Name uz  ; Value{ Term{ [ {u~{3}} ] ;
            In Domain_Mecha  ; Jacobian Vol; } } }
      If(Flag_Plasticity)
      { Name PK2_xx; Value{ Term { [ CompXX[PK2[ F_f_Current[(TensorDiag[1.0, 1.0, 1.0] + TensorV[{d u~{1}}, {d u~{2}}, {d u~{3}} ] ) ],
                                                 F_f_Current[(TensorDiag[1.0, 1.0, 1.0] + TensorV[{d u~{1}}[v_TS[]], {d u~{2}}[v_TS[]], {d u~{3}}[v_TS[]] ] ) ],
                                                 F_pg_Current[(GetVariable[ElementNum[], QuadraturePointIndex[]]{$var_F_pg_Current} ) ],
                                                 F_p_Current[(GetVariable[ElementNum[], QuadraturePointIndex[]]{$var_F_p_Current}) ] ]
                                            ] ] ;
            In Domain_Mecha; Jacobian Vol; } } }
      { Name PK2_xy; Value{ Term { [ CompXY[PK2[ F_f_Current[(TensorDiag[1.0, 1.0, 1.0] + TensorV[{d u~{1}}, {d u~{2}}, {d u~{3}} ] ) ],
                                                 F_f_Current[(TensorDiag[1.0, 1.0, 1.0] + TensorV[{d u~{1}}[v_TS[]], {d u~{2}}[v_TS[]], {d u~{3}}[v_TS[]] ] ) ],
                                                 F_pg_Current[(GetVariable[ElementNum[], QuadraturePointIndex[]]{$var_F_pg_Current} ) ],
                                                 F_p_Current[(GetVariable[ElementNum[], QuadraturePointIndex[]]{$var_F_p_Current}) ] ]
                                            ] ] ;
            In Domain_Mecha; Jacobian Vol; } } }
      { Name PK2_xz; Value{ Term { [ CompXZ[PK2[ F_f_Current[(TensorDiag[1.0, 1.0, 1.0] + TensorV[{d u~{1}}, {d u~{2}}, {d u~{3}} ] ) ],
                                                 F_f_Current[(TensorDiag[1.0, 1.0, 1.0] + TensorV[{d u~{1}}[v_TS[]], {d u~{2}}[v_TS[]], {d u~{3}}[v_TS[]] ] ) ],
                                                 F_pg_Current[(GetVariable[ElementNum[], QuadraturePointIndex[]]{$var_F_pg_Current} ) ],
                                                 F_p_Current[(GetVariable[ElementNum[], QuadraturePointIndex[]]{$var_F_p_Current}) ] ]
                                            ] ] ;
            In Domain_Mecha; Jacobian Vol; } } }
      { Name PK2_yx; Value{ Term { [ CompYX[PK2[ F_f_Current[(TensorDiag[1.0, 1.0, 1.0] + TensorV[{d u~{1}}, {d u~{2}}, {d u~{3}} ] ) ],
                                                 F_f_Current[(TensorDiag[1.0, 1.0, 1.0] + TensorV[{d u~{1}}[v_TS[]], {d u~{2}}[v_TS[]], {d u~{3}}[v_TS[]] ] ) ],
                                                 F_pg_Current[(GetVariable[ElementNum[], QuadraturePointIndex[]]{$var_F_pg_Current} ) ],
                                                 F_p_Current[(GetVariable[ElementNum[], QuadraturePointIndex[]]{$var_F_p_Current}) ] ]
                                            ] ] ;
            In Domain_Mecha; Jacobian Vol; } } }
      { Name PK2_yy; Value{ Term { [ CompYY[PK2[ F_f_Current[(TensorDiag[1.0, 1.0, 1.0] + TensorV[{d u~{1}}, {d u~{2}}, {d u~{3}} ] ) ],
                                                 F_f_Current[(TensorDiag[1.0, 1.0, 1.0] + TensorV[{d u~{1}}[v_TS[]], {d u~{2}}[v_TS[]], {d u~{3}}[v_TS[]] ] ) ],
                                                 F_pg_Current[(GetVariable[ElementNum[], QuadraturePointIndex[]]{$var_F_pg_Current} ) ],
                                                 F_p_Current[(GetVariable[ElementNum[], QuadraturePointIndex[]]{$var_F_p_Current}) ] ]
                                            ] ] ;
            In Domain_Mecha; Jacobian Vol; } } }
      { Name PK2_yz; Value{ Term { [ CompYZ[PK2[ F_f_Current[(TensorDiag[1.0, 1.0, 1.0] + TensorV[{d u~{1}}, {d u~{2}}, {d u~{3}} ] ) ],
                                                 F_f_Current[(TensorDiag[1.0, 1.0, 1.0] + TensorV[{d u~{1}}[v_TS[]], {d u~{2}}[v_TS[]], {d u~{3}}[v_TS[]] ] ) ],
                                                 F_pg_Current[(GetVariable[ElementNum[], QuadraturePointIndex[]]{$var_F_pg_Current} ) ],
                                                 F_p_Current[(GetVariable[ElementNum[], QuadraturePointIndex[]]{$var_F_p_Current}) ] ]
                                            ] ] ;
            In Domain_Mecha; Jacobian Vol; } } }
      { Name PK2_zx; Value{ Term { [ CompZX[PK2[ F_f_Current[(TensorDiag[1.0, 1.0, 1.0] + TensorV[{d u~{1}}, {d u~{2}}, {d u~{3}} ] ) ],
                                                 F_f_Current[(TensorDiag[1.0, 1.0, 1.0] + TensorV[{d u~{1}}[v_TS[]], {d u~{2}}[v_TS[]], {d u~{3}}[v_TS[]] ] ) ],
                                                 F_pg_Current[(GetVariable[ElementNum[], QuadraturePointIndex[]]{$var_F_pg_Current} ) ],
                                                 F_p_Current[(GetVariable[ElementNum[], QuadraturePointIndex[]]{$var_F_p_Current}) ] ]
                                            ] ] ;
            In Domain_Mecha; Jacobian Vol; } } }
      { Name PK2_zy; Value{ Term { [ CompZY[PK2[ F_f_Current[(TensorDiag[1.0, 1.0, 1.0] + TensorV[{d u~{1}}, {d u~{2}}, {d u~{3}} ] ) ],
                                                 F_f_Current[(TensorDiag[1.0, 1.0, 1.0] + TensorV[{d u~{1}}[v_TS[]], {d u~{2}}[v_TS[]], {d u~{3}}[v_TS[]] ] ) ],
                                                 F_pg_Current[(GetVariable[ElementNum[], QuadraturePointIndex[]]{$var_F_pg_Current} ) ],
                                                 F_p_Current[(GetVariable[ElementNum[], QuadraturePointIndex[]]{$var_F_p_Current}) ] ]
                                            ] ] ;
            In Domain_Mecha; Jacobian Vol; } } }
      { Name PK2_zz; Value{ Term { [ CompZZ[PK2[ F_f_Current[(TensorDiag[1.0, 1.0, 1.0] + TensorV[{d u~{1}}, {d u~{2}}, {d u~{3}} ] ) ],
                                                 F_f_Current[(TensorDiag[1.0, 1.0, 1.0] + TensorV[{d u~{1}}[v_TS[]], {d u~{2}}[v_TS[]], {d u~{3}}[v_TS[]] ] ) ],
                                                 F_pg_Current[(GetVariable[ElementNum[], QuadraturePointIndex[]]{$var_F_pg_Current} ) ],
                                                 F_p_Current[(GetVariable[ElementNum[], QuadraturePointIndex[]]{$var_F_p_Current}) ] ]
                                            ] ] ;
