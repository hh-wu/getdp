...
pp = "Input/ConstructiveParameters/"; //pas pris en compte dans le scripte python???
ppp = "Input/OptParam/";
...
DefineConstant[
  ...
  /*
  InitialRotorAngle_deg = {30+45/2, Name StrCat["Input/", StrCat[ResId,"Shift rotor position (no remesh) [mech. deg]"]],Highlight "AliceBlue"},
  */
  ...
  Flag_initOpt = {0, Name "Input/OptParam/optInit", Label "TO: Initialize design variable", 
