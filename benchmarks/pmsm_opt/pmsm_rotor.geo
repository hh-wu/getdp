...
rTrans_Pt_Spline[]={r_PtSpline_0, r_PtSpline_1, r_PtSpline_2, r_PtSpline_3, r_PtSpline_4,
                    r_PtSpline_5, r_PtSpline_6, r_PtSpline_7, r_PtSpline_8, r_PtSpline_9, r_PtSpline_10};
...
If (Flag_Spline) //Corriger Ceci !!!
	...
	Delete { Line{cirR_Spline2[]};}
 	...
 	cirR[]+=l_;
        Printf("cirR",cirR[]);
        Transfinite Line{cirR[6]} = 50;
        Transfinite Line{cirR[7]} = 100;
        Transfinite Line{cirR[8]} = 50;
EndIf
//------------------------------------------------------------------------
gap = 0.41999e-03;
pas = gap*0.3/3.0;
