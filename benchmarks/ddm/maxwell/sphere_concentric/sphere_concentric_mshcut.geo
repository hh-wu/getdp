...
Delete Physicals;
If (cpt == 1)
Physical Surface(-1001) = {surf_drf[cpt-1], surf_urf[cpt-1], surf_ulf[cpt-1], surf_dlf[cpt-1], surf_drb[cpt-1], surf_urb[cpt-1], surf_ulb[cpt-1], surf_dlb[cpt-1]};
Physical Surface((4+cpt)*1000) = {surf_drf[cpt], surf_urf[cpt], surf_ulf[cpt], surf_dlf[cpt], surf_drb[cpt], surf_urb[cpt], surf_ulb[cpt], surf_dlb[cpt]};
Physical Volume(6000+cpt) = {vl[cpt-1]};
EndIf

If (cpt == N_DOM)
Physical Surface(-(3+cpt)*1000) = {surf_drf[cpt-1], surf_urf[cpt-1], surf_ulf[cpt-1], surf_dlf[cpt-1], surf_drb[cpt-1], surf_urb[cpt-1], surf_ulb[cpt-1], surf_dlb[cpt-1]};
Physical Surface(2000+N_DOM) = {surf_drf[cpt], surf_urf[cpt], surf_ulf[cpt], surf_dlf[cpt], surf_drb[cpt], surf_urb[cpt], surf_ulb[cpt], surf_dlb[cpt]};
Physical Volume(6000+cpt) = {vl[cpt-1]};
EndIf
...
If (cpt > 0)
  Save Sprintf("sphere_concentric_mshcut%g.msh", cpt-1);
EndIf
...
Delete Physicals;
Physical Surface(-1) = {surf_drf[0], surf_urf[0], surf_ulf[0], surf_dlf[0], surf_drb[0], surf_urb[0], surf_ulb[0], surf_dlb[0]};
Physical Surface(2) = {surf_drf[N_DOM], surf_urf[N_DOM], surf_ulf[N_DOM], surf_dlf[N_DOM], surf_drb[N_DOM], surf_urb[N_DOM], surf_ulb[N_DOM], surf_dlb[N_DOM]};
