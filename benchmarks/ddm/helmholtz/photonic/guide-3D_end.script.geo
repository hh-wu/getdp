...
L1=newll+OFFSET; Line Loop(L1) = {l10,l20,l30,l40};
...
vol = newv+OFFSET ; Volume(vol) = { box } ;

Transfinite Surface{left} Left ;


//Physical Surface(16) = {circsurfs[]} ;
Physical Surface(13) = {back,front,top,bottom,right} ; // ABC
