...
Formulation {
  { Name MagSta_phi ; Type FemEquation ;
    ...
    Equation {
      ...
      Galerkin { [ - mu[] * hc[] , {d phi} ] ;
        In DomainM ; Jacobian JVol ; Integration I1 ; }
  ...
  { Name PrimalSystem /*MagSta_a*/; Type FemEquation ;
    Quantity {
...
PostProcessing {
  { Name MagSta_phi ; NameOfFormulation MagSta_phi ;
    Quantity {
      { Name b   ; Value { Local { [ - mu[] * {d phi} ] ; In Domain ; Jacobian JVol ; }
                           Local { [ - mu[] * hc[] ] ; In DomainM ; Jacobian JVol ; } } }
      { Name h   ; Value { Local { [ - {d phi} ] ; In Domain ; Jacobian JVol ; } } }
      { Name hc  ; Value { Local { [ hc[] ] ; In DomainM ; Jacobian JVol ; } } }
  ...
  { Name MagSta_a ; NameOfFormulation PrimalSystem ;
    PostQuantity {
...
PostOperation {
  ...
  { Name MagSta_a ; NameOfPostProcessing MagSta_a ;
    Operation {
      Print[ b,  OnElementsOf Domain,  File "b.pos" ];
      Print[ br,  OnElementsOf DomainM,  File "br.pos" ];
...
//  R_ = {"OptimStep", Name "GetDP/1ResolutionChoices", Visible 0},
