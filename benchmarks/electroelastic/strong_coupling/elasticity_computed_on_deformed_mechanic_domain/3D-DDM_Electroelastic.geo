...
For x In {0:nx-1}
	For y In {0:ny-1}
		...
		omega~{x+nx*y+1} 				= 1000*nx*ny+4*x+nx*4*y+1;
		mechanic_solid~{x+nx*y+1}			= 1000*nx*ny+4*x+nx*4*y+2;
		air~{x+nx*y+1}					= 1000*nx*ny+4*x+nx*4*y+3;
		electric_solid~{x+nx*y+1}			= 1000*nx*ny+4*x+nx*4*y+4;
