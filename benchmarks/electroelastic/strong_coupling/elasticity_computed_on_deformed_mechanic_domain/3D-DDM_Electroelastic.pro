// THE FOLLOWING CODE SOLVES A STRONGLY COUPLED (AKA. MONOLITHIC) RESOLUTION OF THE ELECTROELASTIC FORMULATION ON THE DEFORMED MECHANIC DOMAIN (I.E. THE MECHANIC COMPUTATION SHOULD BE SOMEWHAT MORE ACCURATE SINCE THE STIFFNESS OF THE MEMBRANE IS COMPUTED ON THE DEFORMED MEMBRANE).
