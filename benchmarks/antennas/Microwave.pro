...
PostOperation {
  ...
  { Name Microwave_e ; NameOfPostProcessing Microwave_e ;
    Operation {
      ...
      Print[ Gin, OnRegion SkinFeed, Format Table, SendToServerReal StrCat[ppe,"G=re(Y)"], Color "Ivory", File StrCat[myDir,"temp.dat"] ] ;
      Print[ Bin, OnRegion SkinFeed, Format Table, SendToServerReal StrCat[ppe,"B=im(Y)"], Color "Ivory", File StrCat[myDir,"temp.dat"] ] ;

      Print[ Gam, OnRegion SkinFeed, Format FrequencyTable, Store 8, File > StrCat[myDir,Sprintf("Gamma_pml%g.dat", !Flag_SilverMuller)] ];
      Print[ reGam, OnRegion SkinFeed, Format Table, SendToServerReal StrCat[ppe,"re(Gam)"], Color "Ivory", File StrCat[myDir,"temp.dat"] ] ;
      Print[ imGam, OnRegion SkinFeed, Format Table, SendToServerReal StrCat[ppe,"im(Gam)"], Color "Ivory", File StrCat[myDir,"temp.dat"] ] ;
    }
  }
  ...
  { Name Microwave_av ; NameOfPostProcessing Microwave_av ;
    Operation {
      ...
      Print[ Gin, OnRegion SkinFeed, Format Table, SendToServerReal StrCat[ppa,"G=re(Y)"], Color "Ivory", File StrCat[myDir,"temp.dat"] ] ;
      Print[ Bin, OnRegion SkinFeed, Format Table, SendToServerReal StrCat[ppa,"B=im(Y)"], Color "Ivory", File StrCat[myDir,"temp.dat"] ] ;
      ...
      Print[ reGam, OnRegion SkinFeed, Format Table, SendToServerReal StrCat[ppa,"re(Gam)"], Color "Ivory", File StrCat[myDir,"temp.dat"] ] ;
      Print[ imGam, OnRegion SkinFeed, Format Table, SendToServerReal StrCat[ppa,"im(Gam)"], Color "Ivory", File StrCat[myDir,"temp.dat"] ] ;
    }
  }
