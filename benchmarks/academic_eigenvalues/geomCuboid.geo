...
p1[] += newp ; Point(newp) = { 1, 0, 0} ;
p1[] += newp ; Point(newp) = { 1, 1, 0} ;
p1[] += newp ; Point(newp) = { 0, 1, 0} ;
p2[] += newp ; Point(newp) = { 0, 0, 1} ;
p2[] += newp ; Point(newp) = { 1, 0, 1} ;
p2[] += newp ; Point(newp) = { 1, 1, 1} ;
p2[] += newp ; Point(newp) = { 0, 1, 1} ;
