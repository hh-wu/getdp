...
Group {
  ...
  DefineVariable[ Val_Rint, Val_Rext, Cx=0, Cy=0, Cz=0];
...
Jacobian {
  { Name Vol ;
    Case { { Region DomainInf ;
	    Jacobian VolSphShell {Val_Rint, Val_Rext, Cx, Cy, Cz} ; }
...
If (Flag_Axisymmetry == 2)  // Axisymmetry
Jacobian {
  { Name Vol ;
    Case { { Region DomainInf ;
             Jacobian VolAxiSphShell {Val_Rint, Val_Rext, Cx, Cy, Cz} ; }
...
If (Flag_Axisymmetry == 1)  // Axisymmetry, square
Jacobian {
  { Name Vol ;
    Case { { Region DomainInf ;
             Jacobian VolAxiSquSphShell {Val_Rint, Val_Rext, Cx, Cy, Cz} ; }
