...
If (angleInter == 0)
  For n In {0:(NbPorts-1)}
    ...
    p[] += newp ; Point(newp) = { R*Cos[phi2]+L*Cos[phi1], R*Sin[phi2]+L*Sin[phi1], 0} ;
    p[] += newp ; Point(newp) = { R*Cos[phi2]            , R*Sin[phi2]            , 0} ;
    p[] += newp ; Point(newp) = { R*Cos[phi2]+L*Cos[phi3], R*Sin[phi2]+L*Sin[phi3], 0} ;
  EndFor
  For n In {0:(NbPorts-1)}
...
If (angleInter != 0)
  For n In {0:(NbPorts-1)}
    ...
    p[] += newp ; Point(newp) = { R*Cos[phi2]+L*Cos[phi1], R*Sin[phi2]+L*Sin[phi1], 0} ;
    p[] += newp ; Point(newp) = { R*Cos[phi2]            , R*Sin[phi2]            , 0} ;
    p[] += newp ; Point(newp) = { R*Cos[phi3]            , R*Sin[phi3]            , 0} ;
    p[] += newp ; Point(newp) = { R*Cos[phi3]+L*Cos[phi4], R*Sin[phi3]+L*Sin[phi4], 0} ;
  EndFor
  For n In {0:(NbPorts-1)}
