...
#define HEXAHEDRON_2_20N (1<<17)

#define LINE_3           (1<<18)
#define TRIANGLE_3       (1<<19)
#define QUADRANGLE_3     (1<<20)
#define TETRAHEDRON_3    (1<<21)
#define HEXAHEDRON_3     (1<<22)
#define PRISM_3          (1<<23)
#define PYRAMID_3        (1<<24)

#define LINE_4           (1<<25)
#define TRIANGLE_4       (1<<26)
#define QUADRANGLE_4     (1<<27)
#define TETRAHEDRON_4    (1<<28)
#define HEXAHEDRON_4     (1<<29)
#define PRISM_4          (1<<30)
#define PYRAMID_4        (1<<31)
