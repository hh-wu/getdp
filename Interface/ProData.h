...
#define OPERATION_SETEXTRAPOLATIONORDER    107
#define OPERATION_SETINCREMENTASSOLUTION   108
#define OPERATION_GENERATE_UNASSEMBLED_RHS 109
#define OPERATION_SOLVE_MULTIPLE_RHS       110
