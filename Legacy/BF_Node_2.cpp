		...
		double u, double v, double w,  double *s)
{
  ...
  case HEXAHEDRON :
    switch(NumEntity) {
    case 1   : *s = (1.-u) * (1.-v) * (1.-w) * 0.125 * (1.+u) * (1.-v) * (1.-w) * 0.125; break ;
    case 2   : *s = (1.-u) * (1.-v) * (1.-w) * 0.125 * (1.-u) * (1.+v) * (1.-w) * 0.125; break ;
    case 3   : *s = (1.-u) * (1.-v) * (1.-w) * 0.125 * (1.-u) * (1.-v) * (1.+w) * 0.125; break ;
    case 4   : *s = (1.+u) * (1.-v) * (1.-w) * 0.125 * (1.+u) * (1.+v) * (1.-w) * 0.125; break ;
    case 5   : *s = (1.+u) * (1.-v) * (1.-w) * 0.125 * (1.+u) * (1.-v) * (1.+w) * 0.125; break ;
    case 6   : *s = (1.+u) * (1.+v) * (1.-w) * 0.125 * (1.-u) * (1.+v) * (1.-w) * 0.125; break ;
    case 7   : *s = (1.+u) * (1.+v) * (1.-w) * 0.125 * (1.+u) * (1.+v) * (1.+w) * 0.125; break ;
    case 8   : *s = (1.-u) * (1.+v) * (1.-w) * 0.125 * (1.-u) * (1.+v) * (1.+w) * 0.125; break ;
    case 9   : *s = (1.-u) * (1.-v) * (1.+w) * 0.125 * (1.+u) * (1.-v) * (1.+w) * 0.125; break ;
    case 10  : *s = (1.-u) * (1.-v) * (1.+w) * 0.125 * (1.-u) * (1.+v) * (1.+w) * 0.125; break ;
    case 11  : *s = (1.+u) * (1.-v) * (1.+w) * 0.125 * (1.+u) * (1.+v) * (1.+w) * 0.125; break ;
    case 12  : *s = (1.+u) * (1.+v) * (1.+w) * 0.125 * (1.-u) * (1.+v) * (1.+w) * 0.125; break ;
    default : WrongNumEntity ;
    }
    break ;
		...
		double u, double v, double w,  double *s)
{
  ...
  case HEXAHEDRON :
    *s = (1.-u) * (1.-v) * (1.-w) * 0.125 * (1.+u) * (1.+v) * (1.+w) * 0.125;
    break ;
		     ...
		     double u, double v, double w,  double s[])
{
  ...
  case HEXAHEDRON :
    switch(NumEntity) {
    case 1   : s[0] = (-2*u) * (1.-v) * (1.-w) * 0.125 * (1.-v) * (1.-w) * 0.125; 
               s[1] = (1.-u) * (-2)*(1.-v) * (1.-w) * 0.125 * (1.+u) * (1.-w) * 0.125; 
               s[2] = (1.-u) * (1.-v) * (-2)*(1.-w) * 0.125 * (1.+u) * (1.-v) * 0.125; break ;

    case 2   : s[0] = (-2)*(1.-u) * (1.-v) * (1.-w) * 0.125 * (1.+v) * (1.-w) * 0.125; 
               s[1] = (1.-u) * (-2*v) * (1.-w) * 0.125 * (1.-u) * (1.-w) * 0.125; 
	       s[2] = (1.-u) * (1.-v) * (-2)*(1.-w) * 0.125 * (1.-u) * (1.+v) * 0.125; break ;

    case 3   : s[0] = (-2)*(1.-u) * (1.-v) * (1.-w) * 0.125 * (1.-v) * (1.+w) * 0.125; 
               s[1] = (1.-u) * (-2)*(1.-v) * (1.-w) * 0.125 * (1.-u) * (1.+w) * 0.125; 
	       s[2] = (1.-u) * (1.-v) * (-2*w) * 0.125 * (1.-u) * (1.-v) * 0.125; break ;

    case 4   : s[0] = 2*(1.+u) * (1.-v) * (1.-w) * 0.125 * (1.+v) * (1.-w) * 0.125; 
               s[1] = (1.+u) * (-2*v) * (1.-w) * 0.125 * (1.+u) * (1.-w) * 0.125; 
	       s[2] = (1.+u) * (1.-v) * (-2)*(1.-w) * 0.125 * (1.+u) * (1.+v) * 0.125; break ;

    case 5   : s[0] = 2*(1.+u) * (1.-v) * (1.-w) * 0.125 * (1.-v) * (1.+w) * 0.125; 
               s[1] = (1.+u) * (-2)*(1.-v) * (1.-w) * 0.125 * (1.+u) * (1.+w) * 0.125; 
	       s[2] = (1.+u) * (1.-v) * (-2*w) * 0.125 * (1.+u) * (1.-v) * 0.125; break ;
 
    case 6   : s[0] = (-2*u) * (1.+v) * (1.-w) * 0.125 * (1.+v) * (1.-w) * 0.125; 
               s[1] = (1.+u) * 2*(1.+v) * (1.-w) * 0.125 * (1.-u) * (1.-w) * 0.125; 
	       s[2] = (1.+u) * (1.+v) * (-2)*(1.-w) * 0.125 * (1.-u) * (1.+v) * 0.125; break ;

    case 7   : s[0] = 2*(1.+u) * (1.+v) * (1.-w) * 0.125 * (1.+v) * (1.+w) * 0.125; 
               s[1] = (1.+u) * 2*(1.+v) * (1.-w) * 0.125 * (1.+u) * (1.+w) * 0.125; 
	       s[2] = (1.+u) * (1.+v) * (-2*w) * 0.125 * (1.+u) * (1.+v) * 0.125; break ;

    case 8   : s[0] = (-2)*(1.-u) * (1.+v) * (1.-w) * 0.125 * (1.+v) * (1.+w) * 0.125; 
               s[1] = (1.-u) * 2*(1.+v) * (1.-w) * 0.125 * (1.-u) * (1.+w) * 0.125; 
	       s[2] = (1.-u) * (1.+v) * (-2*w) * 0.125 * (1.-u) * (1.+v) * 0.125; break ;

    case 9   : s[0] = (-2*u) * (1.-v) * (1.+w) * 0.125 * (1.-v) * (1.+w) * 0.125; 
               s[1] = (1.-u) * (-2)*(1.-v) * (1.+w) * 0.125 * (1.+u) * (1.+w) * 0.125; 
	       s[2] = (1.-u) * (1.-v) * 2*(1.+w) * 0.125 * (1.+u) * (1.-v) * 0.125; break ;

    case 10  : s[0] = (-2)*(1.-u) * (1.-v) * (1.+w) * 0.125 * (1.+v) * (1.+w) * 0.125;
               s[1] = (1.-u) * (-2*v) * (1.+w) * 0.125 * (1.-u) * (1.+w) * 0.125; 
	       s[2] = (1.-u) * (1.-v) * 2*(1.+w) * 0.125 * (1.-u) * (1.+v) * 0.125; break ;

    case 11  : s[0] = 2*(1.+u) * (1.-v) * (1.+w) * 0.125 * (1.+v) * (1.+w) * 0.125; 
               s[1] = (1.+u) * (-2*v) * (1.+w) * 0.125 * (1.+u) * (1.+w) * 0.125; 
	       s[2] = (1.+u) * (1.-v) * 2*(1.+w) * 0.125 * (1.+u) * (1.+v) * 0.125; break ;

    case 12  : s[0] = (-2*u) * (1.+v) * (1.+w) * 0.125 * (1.+v) * (1.+w) * 0.125; 
               s[1] = (1.+u) * 2*(1.+v) * (1.+w) * 0.125 * (1.-u) * (1.+w) * 0.125; 
	       s[2] = (1.+u) * (1.+v) * 2*(1.+w) * 0.125 * (1.-u) * (1.+v) * 0.125; break ;
		    ...
		    double u, double v, double w,  double s[])
{
  ...
  case HEXAHEDRON :
    ...
    case 2   : s[0] = (-2*u) * (1.-v) * (1.-w) * 0.125 * (1.+v) * (1.-w) * 0.125;
               s[1] = (1.-u) * (-2*v) * (1.-w) * 0.125 * (1.+u) * (1.-w) * 0.125;
               s[2] = (1.-u) * (1.-v) * (-2)*(1.-w) * 0.125 * (1.+u) * (1.+v) * 0.125; break;
    ...
    case 5   : s[0] = (-2*u) * (1.+v) * (1.-w) * 0.125 * (1.+v) * (1.+w) * 0.125;
               s[1] = (1.+u) * 2*(1.+v) * (1.-w) * 0.125 * (1.-u) * (1.+w) * 0.125;
               s[2] = (1.+u) * (1.+v) * (-2*w) * 0.125 * (1.-u) * (1.+v) * 0.125; break;
		    ...
		    double u, double v, double w,  double s[])
{
  ...
  case HEXAHEDRON :
    s[0] = (-2*u) * (1.-v) * (1.-w) * 0.125 * (1.+v) * (1.+w) * 0.125;
    s[1] = (1.-u) * (-2*v) * (1.-w) * 0.125 * (1.+u) * (1.+w) * 0.125;
    s[2] = (1.-u) * (1.-v) * (-2*w) * 0.125 * (1.+u) * (1.+v) * 0.125;
    break ;
