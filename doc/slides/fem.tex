% $Id: fem.tex,v 1.8 2001-06-15 12:34:35 geuzaine Exp $
...
finite volumes, finite elements, integral methods) is well known, and future
...
\begin{slideitemize}
\item 1960s for mechanical problems (very large \emph{application range}
since the 1980s)
...
interpolation, conform vs. non conform meshes, implicit vs. explicit time
integration, ...)
