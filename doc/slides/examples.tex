% $Id: examples.tex,v 1.8 2001-06-16 05:50:41 geuzaine Exp $
...
\end{center}
\begin{slideitemize}
\item E.g.\ temperature $T$ formulation
...
\end{center}
\begin{slideitemize}
\item Addition of transport term (e.g.\ modified Ohm law:
...
\begin{smallsyntax}
Resolution \{ \CC{Mag freq + The time}
  \{ Name Magnetothermal_h_T;
    ...
    Operation \{
      ...
      IterativeLoop \{
        ...
        Operation \{ GenerateJac Mag; SolveJac Mag; 
                    GenerateJac The; SolveJac The; \} \}
