% $Id: getdp.tex,v 1.21 2002-09-06 16:24:02 geuzaine Exp $
...
\item \emph{Time} states (static, harmonic, transient, eigen values)
\end{slideitemize}
...
TimeFct[] = Cos[2*Pi*f*$Time] * Exp[-$Time/0.01]; \CC{current val.}
\end{syntax}
...
\mybox{colbox}{11\semcm}{
  ...
  \item Piecewise definition of any quantity of interest
