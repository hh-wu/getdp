% $Id: getdp.tex,v 1.3 2001-06-13 08:38:05 geuzaine Exp $
...
mu[Air] = mu0; 
mu[Core] = mu0 + 1/(100+100*$1^6); \CC{argument}
...
\begin{syntax}
\{ Name Jacobian1 ;
  Case \{ \CC{piecewise defined on groups}
...
\mybox{colbox}{11\semcm}{
  \begin{slideitemize}
  \item Definition of the any quantity of interest, based on
  the quantities defined in a formulation
  \item Piecewise defintion
...
\mybox{colbox}{11\semcm}{
  ...
  global evaluation, ...)
  \item Operations post-processing quantities (sorting, smoothing,
  adaptation, ...) 
