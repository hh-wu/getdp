$Id: README.txt,v 1.1 2001-02-20 10:20:26 geuzaine Exp $
...
processing. To lauch GetDP on Windows, you thus have to first open a
DOS command shell. The problem definition files are regular ASCII
files: you can thus create them with whatever editor you like
(e.g. Wordpad).
